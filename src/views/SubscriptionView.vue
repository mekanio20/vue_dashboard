                ...
                <tr v-for="item in subscriptions" :key="item.id">
                    ...
                    <a
                      ...
                      @click="
                        (subscription__update.id = item.id),
                          ...
                          (subscription__update.product_limit = String(
                            item.p_limit
                          )),
                          (subscription__update.product_image_limit = String(
                            item.p_img_limit
                          )),
                          (subscription__update.seller_banner_limit = String(
                            item.seller_banner_limit
                          )),
                          (subscription__update.main_banner_limit = String(
                            item.main_banner_limit
                          )),
                          (subscription__update.notification_limit = String(
                            item.ntf_limit
                          )),
                          (subscription__update.voucher_limit = String(
                            item.voucher_limit
                          )),
                          (subscription__update.smm_support = item.smm_support),
                          (subscription__update.tech_support =
                            item.tech_support)
                      "
                      >Edit</a
                    >
                  ...
                  <td>
                    <button
                      ...
                      @click="deleteSubscrpition(item.id)"
                    >
                      Delete
                    </button>
                  </td>
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  <NumberInput
                    label="Product limit"
                    placeholder="limit"
                    v-model="subscription.product_limit"
                    required="true"
                  ></NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Product image limit"
                    placeholder="limit"
                    v-model="subscription.product_image_limit"
                    required="true"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Seller banner limit"
                    placeholder="limit"
                    v-model="subscription.seller_banner_limit"
                    required="true"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Main banner limit"
                    placeholder="limit"
                    v-model="subscription.main_banner_limit"
                    required="true"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    ...
                    placeholder="limit"
                    v-model="subscription.notification_limit"
                    required="true"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Voucher limit"
                    placeholder="limit"
                    v-model="subscription.voucher_limit"
                    required="true"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <BooleanInput
                    label="Smm support"
                    v-model="subscription.smm_support"
                  >
                  </BooleanInput>
                </div>
                <div class="mb-3">
                  <BooleanInput
                    label="Tech support"
                    v-model="subscription.tech_support"
                  >
                  </BooleanInput>
                </div>
              </div>
        ...
        <div id="update" class="col-lg-4">
          <div class="row row-cards">
            <form @submit.prevent="updateSubscription" class="card">
              <div class="card-header">
                <h2 class="card-title">Update Subscription</h2>
              </div>
              <div class="card-body">
                <div class="mb-3">
                  <TextInput
                    label="Name"
                    placeholder="name"
                    v-model="subscription__update.name"
                    required="false"
                  >
                  </TextInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Price"
                    placeholder="price"
                    v-model="subscription__update.price"
                    required="false"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Order"
                    placeholder="order"
                    v-model="subscription__update.order"
                    required="false"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Product limit"
                    placeholder="limit"
                    v-model="subscription__update.product_limit"
                    required="false"
                  ></NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Product image limit"
                    placeholder="limit"
                    v-model="subscription__update.product_image_limit"
                    required="false"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Seller banner limit"
                    placeholder="limit"
                    v-model="subscription__update.seller_banner_limit"
                    required="false"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Main banner limit"
                    placeholder="limit"
                    v-model="subscription__update.main_banner_limit"
                    required="false"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Notification limit"
                    placeholder="limit"
                    v-model="subscription__update.notification_limit"
                    required="false"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <NumberInput
                    label="Voucher limit"
                    placeholder="limit"
                    v-model="subscription__update.voucher_limit"
                    required="false"
                  >
                  </NumberInput>
                </div>
                <div class="mb-3">
                  <BooleanInput
                    label="Smm support"
                    v-model="subscription__update.smm_support"
                  >
                  </BooleanInput>
                </div>
                <div class="mb-3">
                  <BooleanInput
                    label="Tech support"
                    v-model="subscription__update.tech_support"
                  >
                  </BooleanInput>
                </div>
              </div>
